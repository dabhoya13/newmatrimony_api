                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => AddUser(model: localList![index]),
                      ));
                    },
                    child: Container(
                      child: Card(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        setState(() {
                                          if (localList![index].favUser ==
                                              false) {
                                            localList![index].favUser = true;
                                          } else if (localList![index]
                                                  .favUser ==
                                              true) {
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Image.network(
                                          localList![index].images.toString(),
                                          height: 130,
                                        ),
                                      ),
                                      SizedBox(
